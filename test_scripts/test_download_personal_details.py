...
class Test_TC007_MyInfo:
    def test_download_personal_details(self):
        ...
        with allure.step("Login to the application"):
            ...
            Excel_Utils.write_data_to_excel(excel_path, "Download Personal Details", credentials)
        ...
        with allure.step("Add/Update Personal Details"):
            ...
            Excel_Utils.write_data_to_excel(excel_path, "Download Personal Details", personal)
            ...
            Excel_Utils.write_data_to_excel(excel_path, "Download Personal Details", success_message)
